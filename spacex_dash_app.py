...
def get_pie_chart(entered_site):
    filtered_df = spacex_df.groupby("Launch Site")[["Launch Site", "class"]].sum()
    if entered_site == "ALL":
        ...
        filtered_df = spacex_df[spacex_df["Launch Site"] == entered_site].groupby("class")[["Launch Site", "class"]].count()
        fig = px.pie(filtered_df, values="class", 
        names=filtered_df.index, 
